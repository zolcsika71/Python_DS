...
def main():
    ...
    # 2. Fix Anomalies
    print("[INFO] Fixing known anomalies...")
    ...
    print("[INFO] Generating plots and evaluation...")
    ...
    plot_train_test_distribution(
        train_proba, 
        test_proba, 
        os.path.join("plots", "train_test_distribution_comparison.png")
    )

    plot_roc_curve(
        y, 
        train_proba, 
        os.path.join("plots", "train_roc_curve.png")
    )
